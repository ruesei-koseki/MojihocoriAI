                ...
                if Levenshtein.ratio(into,  DATA.data["sentence"][i][0]) >= rate:
                    ...
                    if reply:
                        ...
                        for myname in DATA.settings["mynames"].split("|"):
                            if DATA.data["sentence"][i+1][1] == myname:
                                isMine = True
                        if i != len(DATA.data["sentence"]) and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentenceInput) < 0.75 and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentence) < 0.75 and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentenceHeart) < 0.75 and "!system" not in DATA.data["sentence"][i+1][1]:
                            print("返信: {}, {}".format(DATA.data["sentence"][i+1][0], i+1))
                            flag = True
                            iii = 100
                            for iiiii in range(4):
                ...
                if Levenshtein.ratio(into,  DATA.data["sentence"][i][0]) >= rate:
                    ...
                    if reply:
                        ...
                        for myname in DATA.settings["mynames"].split("|"):
                            if DATA.data["sentence"][i+1][1] == myname:
                                isMine = True
                        if i != len(DATA.data["sentence"]) and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentenceInput) < 0.75 and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentence) < 0.75 and Levenshtein.ratio(DATA.data["sentence"][i+1][0], DATA.lastSentenceHeart) < 0.75 "!system" not in DATA.data["sentence"][i+1][1]:
                            print("返信: {}, {}".format(DATA.data["sentence"][i+1][0], i+1))
                            flag = True
                            iii = 100
                            for iiiii in range(4):
